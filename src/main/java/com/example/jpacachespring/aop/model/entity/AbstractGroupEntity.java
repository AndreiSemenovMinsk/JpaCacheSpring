...
@Table(uniqueConstraints = {
        @UniqueConstraint(name="UC_categorySuperGroup_name", columnNames={"name"}),
...
//    private Action targetAtAction;
    ...
    private List<Action> productSourceActionList = new ArrayList<>();

    @OneToMany(mappedBy = "productTarget")
    private List<Action> productTargetActionList = new ArrayList<>();
